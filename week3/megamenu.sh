...
read -p "type the name of the folder you would like to copy:" folderName
      ...
      if [ -d "$folderName" ]; then
        ...
        echo $folder "has been copied to " $newFolderName
    ...
    3)
      ...
      echo "Secret Password has been created"
;;
...
do
    ...
    6)  ### --- Option 6 Checkcing file name and its content --- ###
...
;;
    7) ### --- Option 7 Download File and storing into a specified Folder --- ###
...
do
    ...
    read -p "Enter the website name or type exit to quit: " website
done
